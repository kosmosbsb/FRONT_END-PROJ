...
<meta property="og:url" content="https://spacecloud.kr/policyPerson" />
...
<header class="header header_sub">
    ...
    <div class="page_title"><h2>개인정보처리방침</h2></div>
...
<aside id="all_menu" class="drawer" role="navigation">
		...
		<div id="content_wraper">
			<section class="contents agree">
				<div class="heading_agree">
					...
					<p class="p_enforce_date">시행일자 : 2017년 07월 18일</p>
					<a href="/policyPerson/20170517" class="btn_agree_view">
						<span class="txt_agree_view">이전 <em class="txt_pc">개인정보</em>처리방침 보러가기</span>
					</a>
				</div>
				<div class="agree_wrap">
					<dl>
	<dt class="blind">스페이스클라우드 개인정보처리방침</dt>
	<dd>(주)앤스페이스(이하 ‘회사’)는 정보통신망이용촉진 및 정보보호 등에 관한 법률(이하 ‘정보통신망법’) 등에 따라 회원의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을 수립&middot;공개합니다.</dd>
	...
	<dd>
		<ol>
			...
			<li>4.	개인정보의 수집 방법	
					<ol>
						<li>1)	스페이스클라우드 스페이스클라우드 PC/모바일회원가입, 고객센터를 통한 유선 상담, 이메일을 통한 온라인 상담, 네이버 톡톡을 통한 온라인 상담</li>
	...
	<dd>
		...
		<table>
			...
			<tr>
				<td>네이버(주), NHN Technology Services(주)</td>
			...
			<tr>
				<td>
					<ul>
						<li>이름: 이건우</li>
						<li>부서명 : 경영지원팀 </li>
						<li>연락처 : <a href="tel:070-4131-9494" class="tel_num">070-4131-9494 </a></li>
						<li>이메일: <a href="mailto:kunq@spacecloud.kr">kunq@spacecloud.kr</a>	</li>
					</ul>
				</td>
				<td>
					<ul>
						...
						<li>부서명 : 서비스기획팀 </li>
						<li>연락처 : <a href="tel:070-4131-9494" class="tel_num">070-4131-9494 </a></li>
						<li>이메일: <a href="mailto:imshow@spacecloud.kr">imshow@spacecloud.kr</a>	</li>
					</ul>
				</td>
			</tr>
			</tbody>
	...
	<dd>
		<ol>
			...
			<li>2.	이 개인정보처리방침은 2017.07.18 부터 적용됩니다</li>
		</ol>
	</dd>
</dl>
				</div>
